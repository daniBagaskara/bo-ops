        ...
        <div>
          <div className="flex items-center space-x-2">
            <h2 className="text-base font-bold text-slate-900">
              Target Penjualan Detail & Formula Otomatis
            </h2>
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Tabel <code className="text-slate-700 bg-slate-200/70 px-1 py-0.5 rounded font-mono">target_penjualan_detail</code>: Hierarki Sales → Relasi → Produk dengan formula STORED Brutto, Rabat, BSR, HPP, & Laba Kotor.
          </p>
        </div>
